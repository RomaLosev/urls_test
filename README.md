...
Время выполнения примерно 3 часа чистого времени. 
Из них 2 часа на тесты, работал с unittest для тестирования django проекта, с pytest только в виде готовых тестов для учебных проектов
В приложении добавил возможность передать ссылки списком, для удобства во время разработки, решил оставить)
